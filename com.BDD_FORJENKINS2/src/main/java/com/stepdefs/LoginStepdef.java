...
public class LoginStepdef {
	...
	//Cucumber annotaion----Hook in Cucumber
	@Before   //This will run before every secenario
	public void setup() {
		 System.setProperty("webdriver.chrome.driver", "chromedriver.exe");
		 driver=new ChromeDriver();
	}
	
	@After    //This will run after every secenario
	...
	public void user_should_be_on_login_page() throws Throwable {
		 ...
		 driver.get("file:///E:/Bhushan%20wagh/OJT%20Files/Selenium%20OJT/javabykiran-Selenium-Softwares/Offline%20Website/index.html");
	}
